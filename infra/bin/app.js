...
const mediaConvertEndpoint = app.node.tryGetContext("mediaConvertEndpoint") || process.env.MEDIACONVERT_ENDPOINT || "https://dummy.mediaconvert.ap-south-1.amazonaws.com";
